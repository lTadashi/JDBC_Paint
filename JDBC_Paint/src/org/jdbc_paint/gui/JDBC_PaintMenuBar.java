...
public class JDBC_PaintMenuBar extends JMenuBar {
	...
	private JRadioButtonMenuItem radioItemLapis, radioItemReta,
			radioItemRetangulo, radioItemElipse;
	...
	private void criarAbaArquivo() {
		...
		menuItemNovo = new JMenuItem("Novo Desenho", new ImageIcon(
				"icones/novo.png"));
		menuItemNovo.setActionCommand("novo");
		menuItemAbrir = new JMenuItem("Abrir...", new ImageIcon(
				"icones/abrir.png"));
		menuItemAbrir.setActionCommand("abrir");
		menuItemSalvar = new JMenuItem("Salvar", new ImageIcon(
				"icones/salvar.png"));
		menuItemSalvar.setActionCommand("salvar");
		menuItemRemover = new JMenuItem("Remover", new ImageIcon(
				"icones/remover.png"));
	...
	private void criarAbaFerramentas() {
		...
		radioItemLapis = new JRadioButtonMenuItem("Lápis", new ImageIcon(
				"icones/lapis.png"));
		radioItemLapis.setActionCommand("lapis");
		radioItemReta = new JRadioButtonMenuItem("Reta", new ImageIcon(
				"icones/reta.png"));
		radioItemReta.setActionCommand("reta");
		radioItemRetangulo = new JRadioButtonMenuItem("Retângular",
				new ImageIcon("icones/retangulo.png"));
		radioItemRetangulo.setActionCommand("retangular");
		radioItemElipse = new JRadioButtonMenuItem("Elipse", new ImageIcon(
				"icones/elipse.png"));
